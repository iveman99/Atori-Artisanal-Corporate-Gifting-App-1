...
class TableLamp : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_table_lamp)
    ...
    private fun fetchEcoFriendlyProducts() {
        ...
        db.collection("Product")
            .whereEqualTo("productCategory", "tablelamp")
            .get()
    ...
    private fun fetchEcoFriendly1Products() {
        val db = FirebaseFirestore.getInstance()
        db.collection("Product")
            .whereEqualTo("productCategory", "tablelamp2")
            .get()
            .addOnSuccessListener { documents ->
                saleProduct.clear()
                for (document in documents) {
